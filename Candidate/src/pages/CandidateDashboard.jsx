...
export default function CandidateDashboard() {
  ...
  const { summary, profile, mappedCompany, recommendedJobs, recentApplications, notifications } =
    state.data;
      ...
      <section className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <PanelCard>
          <SectionHeading
            ...
            title="Apply to current openings from your latest hiring context"
            description="Jobs are ranked from the most relevant mapped or profile-aligned opportunities."
          />
