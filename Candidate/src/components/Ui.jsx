...
export function MetricCard({ label, value, icon: Icon, tone = "blue" }) {
  return (
    <article className="group rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_12px_35px_rgba(15,23,42,0.06)] transition-all duration-200 hover:-translate-y-1 hover:border-lime-300 hover:shadow-[0_20px_50px_rgba(132,204,22,0.16)]">
