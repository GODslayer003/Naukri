...
async function fetchSignupMeta(zone = "") {
  ...
  const response = await fetch(`${API_BASE}/lead-generator/auth/meta${query}`);
    ...
    <div className="login-shell">
      <div className="login-card">
        <div className="login-brand">
          ...
          <h1 className="login-brand-title">Lead Generator Portal</h1>
          <p className="login-brand-sub">
            Register your account to manage lead submissions and route opportunities to your State Manager.
          </p>
          <ul className="login-feature-list">
            {[
              "Submit and track leads in real-time",
              "Forward leads to your assigned State Manager",
        ...
        <div className="login-form-wrap">
          ...
          <p className="login-form-sub">Fill in the details below to create your account.</p>
              ...
              <div className="header-info">
                ...
                <p>
                  {pickerStep === "zone"
                    ...
                    : "All states in this zone are available for Lead Generator signup."}
                </p>
              </div>
