...
const LeadDetailModal = ({ lead, activities = [], onClose, onLogActivity, onEditActivity, onDeleteActivity }) => {
  ...
  const isApproved = normalizedStatus === "CONVERTED";
        ...
        <header className={`modal-header ${isApproved ? "header-approved" : "header-pending"}`}>
          <div className="header-info">
            ...
            <div>
              ...
              <p>ID: {lead.leadCode || lead.id} | {new Date(lead.updatedAt || lead.createdAt || new Date()).toLocaleDateString()}</p>
            </div>
          </div>
        ...
        <div className="modal-body">
          {showAssignedFse && (
            <div className="assigned-fse-banner">
              ...
              <div>
                <span className="banner-label">ASSIGNED USER</span>
